            ...
            <div className="space-y-6">
              <div>
                ...
                <ol className="space-y-3 text-sm text-stone-700 dark:text-stone-300">
                  ...
                  <li className="flex gap-3">
                    ...
                    <span>
                      Click &quot;Edit Config&quot; to open your MCP
                      configuration file
                    </span>
                  </li>
                  <li className="flex gap-3">
              ...
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-950/30">
                <p className="text-sm text-blue-900 dark:text-blue-100">
                  ...
                  questions like &quot;What&apos;s Nikzad&apos;s latest work
                  experience?&quot; or &quot;List Nikzad&apos;s
                  publications&quot; and it will use this MCP server to fetch
                  the data.
                </p>
              </div>
            </div>
