...
export function SocialButton({
    ...
    return (
        ...
        >
            <Icon
                className={cn(
                    "w-4 h-4 text-stone-500/70 dark:text-stone-500 group-hover/btn:text-stone-900 dark:group-hover/btn:text-stone-100 transition-colors duration-300",
                    color
                )}
            />

            <span className="text-sm font-medium text-stone-600 dark:text-stone-400 group-hover/btn:text-stone-900 dark:group-hover/btn:text-stone-100 transition-colors duration-300">
                {label}
            </span>
        </a>
    );
