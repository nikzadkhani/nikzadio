...
try {
    ...
    const educationContent = fs.readFileSync(path.join(dataDir, 'education.toml'), 'utf-8');
    const skillsContent = fs.readFileSync(path.join(dataDir, 'skills.toml'), 'utf-8');
    const publicationsContent = fs.readFileSync(path.join(dataDir, 'publications.toml'), 'utf-8');
